  ...
  const timelineData = [
    {
      ...
      title: "Ngày Độc Lập",
      description:
        "Chủ tịch Hồ Chí Minh đọc Tuyên Ngôn Độc Lập tại Quảng trường Ba Đình, Hà Nội, khai sinh nước Việt Nam Dân chủ Cộng hòa.",
    },
    {
      date: "19/8/1945",
      title: "Cách Mạng Tháng Tám",
      description:
        "Nhân dân Việt Nam đứng lên giành chính quyền từ tay thực dân Pháp và phát xít Nhật.",
    },
    {
      date: "1941-1945",
      title: "Chuẩn Bị Cách Mạng",
      description:
        "Đảng Cộng sản Việt Nam và Mặt trận Việt Minh chuẩn bị lực lượng cho cuộc cách mạng giải phóng dân tộc.",
    },
    {
      date: "1858-1945",
      title: "Thời Kỳ Thuộc Địa",
      description:
        "87 năm đấu tranh chống thực dân Pháp, từ khi Pháp xâm lược đến khi giành được độc lập.",
    },
  ];
    ...
    <div className="tuyen-ngon-page">
      ...
      <section id="hero-section" className="tuyen-ngon-hero">
        ...
        <div className="hero-content ">
          <motion.h1
            className="hero-title bg-gradient-to-r from-yellow-400 via-red-500 to-orange-400 bg-clip-text text-transparent drop-shadow-2xl"
          ...
          >
            <Calendar className="inline-block mr-3" size={40} />2 tháng 9, 1945
          </motion.div>
        ...
        >
          ...
          <div className="document-content">
            ...
            <p>
              ...
              Suy rộng ra, câu ấy có ý nghĩa là: tất cả các dân tộc trên thế
            ...
            <p>
              Đó là những lẽ phải không ai chối cãi được. Thế mà hơn 80 năm nay,
              bọn thực dân Pháp lợi dụng lá cờ tự do, bình đẳng, bác ái, đến
              cướp đất nước ta, áp bức đồng bào ta. Hành động của chúng trái hẳn
            ...
            <p>
              Về kinh tế, chúng bóc lột dân ta đến tận xương tủy, khiến cho dân
              ta nghèo nàn, thiếu thốn, nước ta xơ xác, tiêu điều. Chúng cướp
              không ruộng đất, hầm mỏ, nguyên liệu. Chúng giữ độc quyền in giấy
              bạc, xuất cảng và nhập cảng.
            </p>
            <p>
              Chúng đặt ra hàng trăm thứ thuế vô lý, làm cho dân ta, nhất là dân
              cày và dân buôn, trở nên bần cùng. Chúng không cho các nhà tư sản
              ta ngóc đầu lên được. Chúng bóc lột công nhân ta một cách vô cùng
              tàn nhẫn.
            </p>
            <p>
              Mùa thu năm 1940, phát xít Nhật đến xâm lăng Đông Dương để mở thêm
              căn cứ đánh Đồng minh, thì bọn thực dân Pháp quỳ gối đầu hàng, mở
              cửa nước ta rước Nhật. Từ đó, dân ta chịu hai tầng xiềng xích:
              Pháp và Nhật. Từ đó, dân ta càng cực khổ, nghèo nàn. Kết quả là
              cuối năm ngoái sang đầu năm nay, từ Quảng Trị đến Bắc Kỳ, hơn 2
              triệu đồng bào ta bị chết đói.
            </p>
            <p>
              Ngày 9 tháng 3 năm nay, Nhật tước khí giới của quân đội Pháp. Bọn
              thực dân Pháp hoặc là bỏ chạy, hoặc là đầu hàng. Thế là chẳng
              những chúng không "bảo hộ" được ta, trái lại, trong 5 năm, chúng
              đã bán nước ta hai lần cho Nhật.
            </p>
            <p>
              Trước ngày 9 tháng 3, biết bao lần Việt Minh đã kêu gọi người Pháp
              liên minh để chống Nhật. Bọn thực dân Pháp đã không đáp ứng, lại
              thẳng tay khủng bố Việt Minh hơn nữa. Thậm chí đến khi thua chạy,
              chúng còn nhẫn tâm giết nốt số đông tù chính trị ở Yên Bái và Cao
              Bằng.
            </p>
            <p>
              Tuy vậy, đối với nước Pháp, đồng bào ta vẫn giữ một thái độ khoan
              hồng và nhân đạo. Sau cuộc biến động ngày 9 tháng 3, Việt Minh đã
              giúp cho nhiều người Pháp chạy qua biên thùy, lại cứu cho nhiều
              người Pháp ra khỏi nhà giam Nhật và bảo vệ tính mạng và tài sản
              cho họ.
            </p>
            <p>
            ...
            <p>
              ...
              phải từ tay Pháp. Pháp chạy, Nhật hàng, vua Bảo Đại thoái vị. Dân
              ta đã đánh đổ các xiềng xích thực dân gần 100 năm nay để gây dựng
              nên nước Việt Nam độc lập. Dân ta lại đánh đổ chế độ quân chủ mấy
              mươi thế kỷ mà lập nên chế độ Dân chủ Cộng hòa.
            </p>
            <p>
              Do đó, chúng tôi, lâm thời Chính phủ của nước Việt Nam mới, đại
              biểu cho toàn dân Việt Nam, tuyên bố thoát ly hẳn quan hệ thực dân
              với Pháp, xóa bỏ hết những hiệp ước mà Pháp đã ký về nước Việt
            ...
            <p>
              Chúng tôi tin rằng các nước Đồng minh đã công nhận những nguyên
              tắc dân tộc bình đẳng ở các Hội nghị Têhêran và Cựu Kim Sơn, quyết
              không thể không công nhận quyền độc lập của dân Việt Nam.
            </p>
            <p>
              Một dân tộc đã gan góc chống ách nô lệ của Pháp hơn 80 năm nay,
              một dân tộc đã gan góc đứng về phe Đồng minh chống phát xít mấy
          ...
          <div className="document-signature">
            ...
            <p>
              <strong>Chủ tịch Chính phủ lâm thời</strong>
            </p>
            <p>
      ...
      >
        <div
          ...
          style={{
            textAlign: "center",
            background: "linear-gradient(135deg, #f8f4f0, #f0ebe2)",
          }}
        >
          <motion.div
            animate={{
          ...
          >
            <Star
              className="inline-block mr-3 mb-4"
              size={40}
              color="var(--gold)"
            />
          </motion.div>
