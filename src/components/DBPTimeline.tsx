  ...
  const phases = [
    {
      ...
      description:
        "Vận chuyển vũ khí, lương thực qua đường Trường Sơn. Hàng nghìn dân công xây dựng đường giao thông.",
      icon: Users,
    ...
    },
    {
      ...
      date: "13/3 - 17/3/1954",
      description:
        "Tiêu diệt Him Lam (13/3), Độc Lập (15/3), Bản Kéo (17/3). Đánh chiếm sân bay Mường Thanh.",
      icon: Sword,
    ...
    },
    {
      ...
      date: "30/3 - 26/4/1954",
      description:
        "Phá hủy 5 cứ điểm phía đông, siết chặt vòng vây. Địch co cụm phòng thủ trung tâm.",
      icon: Mountain,
    ...
    },
    {
      ...
      date: "1/5 - 7/5/1954",
      description:
        "Tổng tấn công cuối cùng: cao điểm A1 (6/5) và Hồng Cúm, 7/5/1954 địch đầu hàng.",
      icon: Flag,
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Hành trình 56 ngày đêm chiến đấu anh dũng, từ chuẩn bị đến chiến
            thắng vang dội
          </p>
        </motion.div>
